...
void loop() {
  ...
  data_array[0] = 4095 - analogRead(36);
  data_array[1] = 4095 - analogRead(39);
  data_array[2] = 4095 - analogRead(34);
  data_array[3] = 4095 - analogRead(35);
  data_array[4] = 4095 - analogRead(32);
  data_array[5] = 4095 - analogRead(33);
  data_array[6] = 4095 - analogRead(25);
  data_array[7] = 4095 - analogRead(26);
  data_array[8] = 4095 - analogRead(27);
  data_array[9] = 4095 - analogRead(14);
  data_array[10] = 4095 - analogRead(12);
  data_array[11] = 4095 - analogRead(4);
  data_array[12] = 4095 - analogRead(13);
